...
import { BultoApi, EnvioApi, Bulto, Envio, VoluntarioApi, Voluntario, VehiculoApi, Vehiculo, AsignacionTrasladoBulto, AsignacionTrasladoBultoApi } from 'src/app/service/lbservice';
